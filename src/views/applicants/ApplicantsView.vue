            ...
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" :src="require('@/assets/img/applicants/feature.png')" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
...
<style scoped>
    ...
    .jumbotron {
        background: linear-gradient(rgba(40, 120, 235, 0.9), rgba(40, 120, 235, 0.9)), url(@/assets/img/themeimg/header.jpg), no-repeat center center;
        background-size: cover;
    }

    .jumbotron.page-header {
        background: linear-gradient(rgba(40, 120, 235, 0.9), rgba(40, 120, 235, 0.9)), url(@/assets/img/themeimg/page-header.jpg), no-repeat center center;
        background-size: cover;
    }
    ...
    .overlay-top::before {
        top: 0;
        background: url(@/assets/img/themeimg/overlay-top.png) top center no-repeat;
        background-size: contain;
    }

    .overlay-bottom::after {
        bottom: 0;
        background: url(@/assets/img/themeimg/overlay-bottom.png) bottom center no-repeat;
        background-size: contain;
    }

    .bg-image {
        background: linear-gradient(rgba(40, 120, 235, 0.05), rgba(40, 120, 235, 0.05)), url(@/assets/img/themeimg/bg-image.jpg);
